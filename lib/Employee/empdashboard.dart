import 'package:audiofusion/Employee/addleads.dart';
import 'package:audiofusion/Employee/addreport.dart';
import 'package:audiofusion/admin/allattendence.dart';
import 'package:audiofusion/admin/viewattendance.dart';
...
import 'package:audiofusion/notification.dart';
...
class _EmployeeDashboardState extends State<EmployeeDashboard> {
  ...
  Future<void> _sendTokenToBackend(String token) async {
    ...
    var url = Uri.parse(
        'http://13.201.213.5:4080/emp/employeenotificationtoken?empId=$empId&token=$token');
  ...
  Future<void> _sendDataToBackend(String time, String location, String address,
    ...
    var url = Uri.parse('http://13.201.213.5:4080/emp/addemployeeattendence');
      ...
      child: Column(
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              color:
                  Colors.white.withOpacity(0.1), // Light red background circle
              shape: BoxShape.circle,
            ),
            padding:
                const EdgeInsets.all(12), // Reduced padding inside the circle
            child: Icon(
              icon,
              size: 32, // Slightly smaller icon size
              color: Colors.white, // Red color for the icon
            ),
          ),
          const SizedBox(height: 5), // Reduced spacing between icon and text
          Text(
            label,
            style: TextStyle(
              fontSize: 12, // Slightly smaller text size
