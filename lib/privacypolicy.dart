  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            'This Privacy Policy outlines how we collect, use, and share your information when you use our app available on the Store. By using our app, you agree to the terms outlined in this policy.\n',
          ),
          Text(
          ...
          Text(
            'We may update this Privacy Policy periodically, and we will notify you of any significant changes. For questions or concerns about this policy, please contact us at info@audiofusion.in.\n',
          ),
