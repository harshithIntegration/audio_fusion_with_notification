...
//   bool _isSubmitting = false; // Added state variable for submission state
...
//               child: _isSubmitting
//                   ? CircularProgressIndicator() // Show indicator when submitting
//                   : const Text(
//                       'Submit',
//                       style: TextStyle(
...
//       } finally {
//         setState(() {
//           _isSubmitting = false; // Finish submitting
//         });
//       }
//     }
//   }
...
//     try {
//       const String url = 'http://13.201.213.5:4080/emp/dailyemployeereport';
...
class _ReportSubmissionScreenState extends State<ReportSubmissionScreen> {
  ...
  Future<void> _submit() async {
    if (_isFormValid()) {
      ...
      try {
        await _uploadReport(
            report, date, time, _selectedImageFile, _selectedDocumentFile);
        _reportController.clear();
        setState(() {
          _selectedImageFile = null;
          _selectedDocumentFile = null;
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse != null && jsonResponse['status'] != null) {
          if (jsonResponse['status'] == true) {
            ...
            throw Exception(
                'Failed to submit report: ${jsonResponse['statusMessage']}');
          }
        } else {
