import 'dart:async';
import 'dart:convert';
import 'package:audiofusion/screens/signup_screen.dart';
import 'package:audiofusion/screens/signup_service.dart';
...
class _EmailVerifyOTPState extends State<EmailVerifyOTP> {
  ...
  Future<void> _verifyOTP() async {
    ...
    final Uri url =
        Uri.parse('http://13.201.213.5:4080/pte/signupotpverification');
  ...
  Future<void> resendOTP(String email) async {
    ...
    print("---------");
    try {
      final Uri resendUrl = Uri.parse(
          'http://13.201.213.5:4040/pte/signupresendotp?email=$email');
